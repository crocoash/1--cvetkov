...
echo ==========================================
echo.
echo   1  - Обновить базу, спросив перед тем как выгонять людей
echo   2  - Обновить базу и выгнать людей самому, если понадобится
echo.
echo   Оба пункта делают одно и то же: тянут из GitHub, грузят конфигурацию
echo   и обновляют базу. Пока правки не меняют структуру, база обновляется
echo   на ходу и никого не трогает. Выгон нужен только под структурные правки.
echo.
