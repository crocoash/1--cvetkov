...
echo ==========================================
echo.
echo   1  - Обновить базу целиком (спросит, выгонять ли людей)
...
echo Если в базе окажутся люди, скрипт спросит здесь же, выгонять ли их:
echo ответ "д" - выгнать и доделать обновление, Enter - оставить как есть.
echo.
