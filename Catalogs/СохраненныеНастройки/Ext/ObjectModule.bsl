...
Процедура ПередЗаписью(Отказ)
	...
	Если Отказ Тогда
		Сообщить(Локализация.СтрШаблон1(НСтр("ru='Настройка ""¤1¤"" не может быть записана:';uk='Настройка ""¤1¤"" не може бути записана:'"), Наименование) + Сообщение, СтатусСообщения.Важное);
	КонецЕсли;
