	...
	Если СтруктураШапкиДокумента.ОтражатьВБухгалтерскомУчете Тогда	
		...
		Для Каждого СтрокаТаблицы Из ТаблицаПоТоварам Цикл
			Если СтрокаТаблицы.СчетУчетаБУЗабалансовый = (Не ДолженБытьЗабалансовый) Тогда
				ОпределяющийТекст = ?(СтруктураШапкиДокумента.ВидОперации = Перечисления.ВидыОперацийВозвратТоваровПоставщику.ИзПереработки,"Для вида операции """+СтруктураШапкиДокумента.ВидОперации+"""","Для вида договора """+ДоговорКонтрагента.ВидДоговора+"""");
