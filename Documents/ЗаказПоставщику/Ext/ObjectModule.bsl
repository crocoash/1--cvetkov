...
Функция ПолучитьСтруктуруПечатныхФорм() Экспорт
	...
	СтруктураПечатныхФорм.Вставить("Заказ", "Заказ поставщику");
	СтруктураПечатныхФорм.Вставить("ЗаказПоДаннымПоставщика", "Заказ поставщику (по данным поставщика)");
	СтруктураПечатныхФорм.Вставить("ЗаказКорректировка", "Заказ поставщику (с учетом корректировок)");
