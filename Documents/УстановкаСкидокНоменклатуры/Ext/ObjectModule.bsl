...
Процедура ДвиженияПоРегистрам(СтруктураШапкиДокумента,ТаблицаПоТоварам, ТаблицаПоПолучателям, ТаблицаПоДнямНедели, ТаблицаПоЦеновымГруппам, ТаблицаПоБонусам, Отказ, Заголовок)
	...
	Если Не Отказ И СтруктураШапкиДокумента.ИсключитьКонтрагентовГруппы Тогда
		
		Для Каждого СтрокаТЧ Из ИсключитьКонтрагентаГруппу Цикл
			
			Движение = Движения.СкидкиИсключенияКонтрагентовГрупп.Добавить();
			
			Движение.Период                  = СтруктураШапкиДокумента.Дата;
			Движение.Регистратор             = Ссылка;
			Движение.Активность              = Истина;
			Движение.ДокументУстановкиСкидок = Ссылка;
			Движение.КонтрагентГруппа        = СтрокаТЧ.КонтрагентГруппа;
			Движение.ОтменаИсключения        = Ложь;
