...
Функция ПолучитьСтруктуруПечатныхФорм() Экспорт
	...
	Возврат Новый Структура("НА3","Форма НА-3");
	...
	Для каждого СтрокаТЧ Из ТаблицаПоНМА Цикл
		...
		Если СтрокаОстатков = Неопределено Тогда
			...
			ОбщегоНазначения.ОшибкаПриПроведении("Строка " + СтрокаТЧ.НомерСтроки + "." + Символы.ПС + Символы.Таб
			                    ...
			                    + Символы.ПС + Символы.Таб + "в регистре сведений ""Местонахождение НМА""."
	...
	Для каждого СтрокаТЧ Из ТаблицаПоНМА Цикл
		...
		Если СтрокаОстатков = Неопределено Тогда
			...
			ОбщегоНазначения.ОшибкаПриПроведении("Строка " + СтрокаТЧ.НомерСтроки + "." + Символы.ПС + Символы.Таб
			                    ...
			                    + Символы.ПС + Символы.Таб + "в регистре сведений ""Местонахождение НМА (бухгалтерский учет)""."
