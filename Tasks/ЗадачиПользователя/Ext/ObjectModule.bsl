...
Процедура ПередЗаписью(Отказ)
	...
	// Задачу по цене 1 грн в возврате производства нельзя закрыть,
	// пока цена не исправлена (см. ПроизводствоЧерезВозврат).
	ПроизводствоЧерезВозврат.ПроверитьЗакрытиеЗадачи(ЭтотОбъект, Отказ);
