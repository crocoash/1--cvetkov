...
Процедура ЗаполнитьНачальныеНастройки() Экспорт
	...
	ОбщийОтчет.мНазваниеОтчета = "Состояние кадрового плана";
	ОтчетДиаграмма.ИмяРегистра = "-";
	ОтчетДиаграмма.мНазваниеОтчета = "Состояние кадрового плана";
	...
	ОбщийОтчет.ЗаполнитьПоказатели("ЗанятоСтавок", "Занято рабочих мест", Истина, "ЧЦ=15; ЧДЦ=2");
