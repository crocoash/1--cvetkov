...
//	Если мКодОтчета = мОрганизация Тогда	
		Если Болезни Тогда
			СтруктураПараметров.Вставить("СерияБолеет", ДиаграммаГанта.УстановитьСерию("Болезнь"));
		КонецЕсли;
		Если Командировки Тогда
			СтруктураПараметров.Вставить("СерияКомандировка", ДиаграммаГанта.УстановитьСерию("Командировка"));
		КонецЕсли;
		Если Отпуска Тогда
			СтруктураПараметров.Вставить("СерияВОтпуске", ДиаграммаГанта.УстановитьСерию("Ежегодный отпуск"));
			СтруктураПараметров.Вставить("СерияВОтпускеБезОплаты", ДиаграммаГанта.УстановитьСерию("Отпуск без оплаты"));
			СтруктураПараметров.Вставить("СерияВОтпускеПрочем", ДиаграммаГанта.УстановитьСерию("Прочий отпуск"));
		КонецЕсли;
		Если Прогулы Тогда
			СтруктураПараметров.Вставить("СерияПрогул", ДиаграммаГанта.УстановитьСерию("Отсутствие по невыясненной причине"));
		КонецЕсли;	
//	КонецЕсли; 
...
НоваяСтрока.ВидОтчета = "По работникам организаций";
НоваяСтрока.КодОтчета = мОрганизация;

НоваяСтрока = мТаблицаВидыОтчета.Добавить();
НоваяСтрока.ВидОтчета = "По работникам предприятия";
