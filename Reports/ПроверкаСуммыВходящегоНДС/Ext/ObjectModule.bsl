...
Процедура УстановитьНачальныеНастройки(ДополнительныеПараметры = Неопределено) Экспорт
	...
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("Схема",		 				"Момент возникновения обязательств");
	...
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("ДляХозяйственнойДеятельности","Для хоз. деят.");
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("ВидДеятельностиНДС",			"Вид деят. НДС");
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("Амортизируется",				"Амортизируется");
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("СложныйНалоговыйУчет",		"Сложн. нал. учет");
	
	// Добавление показателей
	// Необходимо вызывать для каждого добавляемого показателя.
	// УниверсальныйОтчет.ДобавитьПоказатель(<ИмяПоказателя>, <ПредставлениеПоказателя>, <ВключенПоУмолчанию>, <Формат>, <ИмяГруппы>, <ПредставлениеГруппы>);
	
	УниверсальныйОтчет.ДобавитьПоказатель("РазницаУчетВыписано", 			"Сумма всего", 	Истина, "ЧЦ=15; ЧДЦ=2","РазницаУчетВыписано", "Расхождение между данными учета и полученными налоговыми документами (только упрощ. нал. учет)");
	УниверсальныйОтчет.ДобавитьПоказатель("РазницаУчетВыписаноНДС", 		"НДС", 			Истина, "ЧЦ=15; ЧДЦ=2","РазницаУчетВыписано");
	
	УниверсальныйОтчет.ДобавитьПоказатель("РазницаУчетДокумент", 		"Сумма всего", Истина, "ЧЦ=15; ЧДЦ=2","РазницаУчетДокумент", "Расхождение между данными учета и первичными документами (только упрощ. нал. учет)");
	УниверсальныйОтчет.ДобавитьПоказатель("РазницаУчетДокументНДС", 	"НДС", 		   Истина, "ЧЦ=15; ЧДЦ=2","РазницаУчетДокумент");
	
	
	УниверсальныйОтчет.ДобавитьПоказатель("ПоДокументу", 		"Сумма всего", 		Истина, "ЧЦ=15; ЧДЦ=2","ПоПроводкам", "Суммы по проводкам документа (только упрощ. нал. учет)");
	УниверсальныйОтчет.ДобавитьПоказатель("ПоДокументуНДС", 	"НДС", 				Истина, "ЧЦ=15; ЧДЦ=2","ПоПроводкам");
	
	УниверсальныйОтчет.ДобавитьПоказатель("ПервоеСобытие", 	    "Сумма всего",  Истина, "ЧЦ=15; ЧДЦ=2","ПервоеСобытие", "Налоговый кредит");
	УниверсальныйОтчет.ДобавитьПоказатель("ПервоеСобытиеНДС", 	"НДС", 			Истина, "ЧЦ=15; ЧДЦ=2","ПервоеСобытие");
	
	УниверсальныйОтчет.ДобавитьПоказатель("ВыписаноНН", 	"Сумма всего", 						Истина, "ЧЦ=15; ЧДЦ=2","ВыписаноНН","Получено налоговых документов");
	УниверсальныйОтчет.ДобавитьПоказатель("ВыписаноНННДС", 	"НДС (только упрощ. нал. учет)", 	Истина, "ЧЦ=15; ЧДЦ=2","ВыписаноНН");
