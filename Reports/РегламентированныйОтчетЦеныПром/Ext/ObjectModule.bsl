...
НоваяФорма.ОписаниеОтчета     = "Затверджена наказом Держкомстату України від 30.06.2009 N 221 (зі змінами, внесеними наказом Держкомстату України від 24.06.2011 р. №152)";
