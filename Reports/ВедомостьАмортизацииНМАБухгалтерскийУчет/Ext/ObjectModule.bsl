...
Процедура ЗаполнитьНачальныеНастройки() Экспорт
	...
	ОбщийОтчет.ЗаполнитьПоказатели("ЛиквидационнаяСтоимость", "Ликвидационная стоимость", Истина, "ЧЦ=15; ЧДЦ=2");
...
ОбщийОтчет.мНазваниеОтчета      = "Ведомость по амортизации НМА (бухгалтерский учет)";
