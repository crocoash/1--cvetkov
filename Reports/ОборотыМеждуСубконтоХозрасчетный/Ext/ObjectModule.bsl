...
Функция ПолучитьОписаниеНастроек()
	...
	СтрокаОписания = Локализация.СтрШаблон1(НСтр("ru='Анализируется ¤1¤ в корреспонденции с ¤2¤';uk='Аналізується ¤1¤ у кореспонденції з ¤2¤'"), Сред(СтрокаСубконто, 3), Сред(СтрокаКорСубконто, 3));
