...
Процедура ЗаполнитьНачальныеНастройки() Экспорт
	...
	ОбщийОтчет.мНазваниеОтчета = "Штатная расстановка";
	...
	ОбщийОтчет.ЗаполнитьПоказатели("Количество", "Количество занятых рабочих мест", Истина, "ЧЦ=15; ЧДЦ=2");
	...
	СтруктураПредставлениеПолей.Вставить("Должность", "Должность");
