...
НоваяФорма.ОписаниеОтчета     = НСтр("ru = 'Утверждена приказом Министерства финансов Украины  от 28.09.2011 №1213'; uk = 'Затверджена наказом Міністерства фінансів України від 28.09.2011 №1213'");
