...
Процедура СформироватьОтчет(ДокументРезультат, ПоказыватьЗаголовок, ВысотаЗаголовка, ТолькоЗаголовок = Ложь, НачалоПодписи, ПоказыватьПодписи) Экспорт
	...
	Пока ВыборкаПериод.Следующий() Цикл
		...
		ЗаголовокОтчета.Параметры.НазваниеОтчета      = НСтр("ru='Списание расходов будущих периодов';uk='Списання витрат майбутніх періодів'");
	...
	ДокументРезультат.ИмяПараметровПечати = НСтр("ru='Списание расходов будущих периодов';uk='Списання витрат майбутніх періодів'");
