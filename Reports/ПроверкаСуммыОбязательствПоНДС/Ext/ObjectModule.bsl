...
Процедура УстановитьНачальныеНастройки(ДополнительныеПараметры = Неопределено) Экспорт
	...
	УниверсальныйОтчет.ДобавитьПоказатель("РазницаУчетВыписано", 			"Сумма всего", 	Истина, "ЧЦ=15; ЧДЦ=2","РазницаУчетВыписано", "Расхождение между данными учета и выписанными налоговыми документами (только упрощ. нал. учет)");
	...
	УниверсальныйОтчет.ДобавитьПоказатель("ПервоеСобытие", 	    "Сумма всего",  Истина, "ЧЦ=15; ЧДЦ=2","ПервоеСобытие", "Налоговые обязательства");
	УниверсальныйОтчет.ДобавитьПоказатель("ПервоеСобытиеНДС", 	"НДС", 			Истина, "ЧЦ=15; ЧДЦ=2","ПервоеСобытие");
	
	УниверсальныйОтчет.ДобавитьПоказатель("ВыписаноНН", 	"Сумма всего", 						Истина, "ЧЦ=15; ЧДЦ=2","ВыписаноНН","Выписано налоговых документов");
