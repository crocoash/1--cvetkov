...
Процедура УстановитьНачальныеНастройки(ДополнительныеПараметры = Неопределено) Экспорт
	...
	Если УниверсальныйОтчет.ИспользоватьСвойстваИКатегории Тогда
		...
		УниверсальныйОтчет.ДобавитьСвойстваИКатегорииДляПоля("РезультатАнализа.Номенклатура", "НоменклатурнаяГруппа", "Номенклатурная группа", ПланыВидовХарактеристик.НазначенияСвойствКатегорийОбъектов.Справочник_НоменклатурныеГруппы);
	...
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("СтоимостьОтклонение", "Отклонение стоимости");
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("СтоимостьОтклонениеСНДС", "Отклонение стоимости (с НДС)");
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("СтоимостьОтклонениеПроцент", "Отклонение стоимости (%)");
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("СтоимостьОтклонениеПроцентСНДС", "Отклонение стоимости (с НДС)(%)");
	...
	УниверсальныйОтчет.ДобавитьПоказатель("Стоимость", "Стоимость", Ложь, "ЧЦ=15; ЧДЦ=2", "Стоимость", "Стоимость");
	УниверсальныйОтчет.ДобавитьПоказатель("СтоимостьСНДС", "Стоимость (с НДС)", Истина, "ЧЦ=15; ЧДЦ=2", "Стоимость");
	УниверсальныйОтчет.ДобавитьПоказатель("НДС", "НДС", Ложь, "ЧЦ=15; ЧДЦ=2", "Стоимость", "Стоимость");
	
	УниверсальныйОтчет.ДобавитьПоказатель("СтоимостьОтклонение", "Стоимость", Ложь, "ЧЦ=15; ЧДЦ=2", "ОтклонениеСтоимости", "Отклонение стоимости");
	УниверсальныйОтчет.ДобавитьПоказатель("СтоимостьОтклонениеСНДС", "Стоимость (с НДС)", Истина, "ЧЦ=15; ЧДЦ=2", "ОтклонениеСтоимости");
	УниверсальныйОтчет.ДобавитьПоказатель("НДСОтклонение", "НДС", Ложь, "ЧЦ=15; ЧДЦ=2", "ОтклонениеСтоимости");
	
	УниверсальныйОтчет.ДобавитьПоказатель("СтоимостьОтклонениеПроцент", "Стоимость, %", Ложь, "ЧЦ=15; ЧДЦ=2", "ОтклонениеСтоимости");
	УниверсальныйОтчет.ДобавитьПоказатель("СтоимостьОтклонениеСНДСПроцент", "Стоимость (с НДС), %", Истина, "ЧЦ=15; ЧДЦ=2", "ОтклонениеСтоимости");
