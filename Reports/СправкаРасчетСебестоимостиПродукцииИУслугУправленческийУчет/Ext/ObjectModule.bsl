...
Процедура СформироватьОтчет(ДокументРезультат, ПоказыватьЗаголовок, ВысотаЗаголовка, ТолькоЗаголовок = Ложь, НачалоПодписи, ПоказыватьПодписи) Экспорт
	...
	Пока ВыборкаПериод.Следующий() Цикл
		...
		ЗаголовокОтчета.Параметры.НазваниеОтчета      = "Себестоимость " + ?(ВариантОперации = 1, "выпущенной продукции и ", "") + "оказанных услуг производственного характера, по которым " + ?(ВариантОперации = 2, "не", "") + " предусмотрены плановые цены (управленческий учет)";
		...
		ОбластьШапка.Параметры.ТекстРасходов       = "Прямые расходы (с НДС)";
		ОбластьШапка.Параметры.ТекстСебестоимости  = "Сумма прямых расходов, приходящаяся на выпуск (с НДС)";
	...
	ДокументРезультат.ИмяПараметровПечати = "Расчет себестоимости продукции (упр. учет)";
