...
Процедура КонтрольОстатков_ПеремещениеТоваров()
	...
	+ ?(ИмяТаблицы = "ПеремещениеТоваров.Товары"," 
...
Процедура ОбработатьРезультатЗапроса(Выборка,ЕстьСерия,ЕстьРезервыПоДокументуБезСерии)
	...
	ПродаватьРезервРеализация = ХранилищеОбщихНастроек.Загрузить("РеализацияТоваровУслуг", "ПродаватьРезервРеализация");
	
	Если ПродаватьРезервРеализация = Неопределено Тогда
	...
	Пока Выборка.Следующий() Цикл
		...
		Если ПродаватьРезервРеализация Тогда
