...
Функция НастройкиПроксиНаКлиенте() Экспорт
	...
	Возврат ОбщегоНазначенияКлиентСерверДополнительно.ХранилищеОбщихНастроекЗагрузить("НастройкаПроксиСервера");
	//
КонецФункции
...
Функция НастройкиПроксиНаСервере() Экспорт
	...
	Если ОбщегоНазначенияПовтИспДополнительно.РежимРаботыПрограммы().Файловый Тогда
