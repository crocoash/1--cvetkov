...
//
Функция СтрШаблон12(Знач СтрокаШаблон, 
										Знач Пар1  = "", Знач Пар2  = "",
...
КонецФункции //СтрШаблон1()

Функция СтрШаблон1 (Сообщ="",Фигня1="",Фигня2="",Фигня3="",Фигня4="",Фигня5="",Фигня6="",Фигня7="",Фигня8="",Фигня9="",Фигня10="") Экспорт 
	Возврат	СтрЗаменить(СтрЗаменить(СтрЗаменить(СтрЗаменить(СтрЗаменить(СтрЗаменить(Сообщ,"¤1¤",Фигня1),"¤2¤",Фигня2),"¤3¤",Фигня2),"¤4¤",Фигня2),"¤5¤",Фигня2),"¤6¤",Фигня2);
КонецФункции
...
Функция ОбработатьПереводы(ПолноеИмяОбъектаМетаданных, ИмяДляПеревода, КодЯзыка)
		...
		ИначеЕсли ПолноеИмяОбъектаМетаданных = "Документ.ВводНачальныхОстатковМалоценкиВЭксплуатации" Тогда 
			Возврат НСтр("ru='Ввод начальных остатков малоценки в эксплуатации';uk='Введення початкових залишків малоцінних активів в експлуатації'" ,КодЯзыка);
		...
		ИначеЕсли ПолноеИмяОбъектаМетаданных = "Документ.ИзменениеНалоговогоНазначенияТЗР" Тогда 
			Возврат НСтр("ru = 'Изменение налогового назначения ТЗР'; uk = 'Зміна податкового призначення ТЗР'" ,КодЯзыка);
		...
		ИначеЕсли ПолноеИмяОбъектаМетаданных = "Документ.ПередачаОборудованияВМонтаж" Тогда 
			Возврат НСтр("ru='Передача оборудования в монтаж';uk='Передача обладнання в монтаж'" ,КодЯзыка);
		...
		ИначеЕсли ПолноеИмяОбъектаМетаданных = "Документ.ПеремещениеМалоценкиВЭксплуатации" Тогда 
			Возврат НСтр("ru='Перемещение малоценки в эксплуатации';uk='Переміщення малоцінних активів в експлуатації'" ,КодЯзыка);
		...
		ИначеЕсли ПолноеИмяОбъектаМетаданных = "Документ.СписаниеМалоценкиИзЭксплуатации" Тогда 
			Возврат НСтр("ru='Списание малоценки из эксплуатации';uk='Списання малоцінних активів з експлуатації'" ,КодЯзыка);
		...
		ИначеЕсли ПолноеИмяОбъектаМетаданных = "Перечисление.ТипыДомов" Тогда
			Если ИмяДляПеревода = "Дом" Тогда
				Возврат НСтр( "ru='дом';uk='буд.';" ,КодЯзыка);
		...
		ИначеЕсли ПолноеИмяОбъектаМетаданных = "Перечисление.ТипыКорпусов" Тогда
			Если ИмяДляПеревода = "Корпус" Тогда
				Возврат НСтр( "ru='корп.';uk='корп.';" ,КодЯзыка);
...
Процедура ПроверитьСоответсвиеЯзыкаПлатформыИПользователя() Экспорт
	...
	Если ЯзыкПлатформы <> ЯзыкИнтерфейса Тогда
		Сообщить(СтрШаблон1(НСтр("ru='Язык интерфейса платформы 1С:Предприятие (""¤1¤"") не совпадает с языком интерфейса пользователя (""¤2¤"")!"
