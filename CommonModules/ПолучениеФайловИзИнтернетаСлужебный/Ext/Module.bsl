...
Процедура СохранитьНастройкиПроксиНаСервере1СПредприятие(знач Настройки) Экспорт
	 Если НЕ ПользователиДополнительно.ЭтоПолноправныйПользователь(, Истина) Тогда
...
Процедура ОбновитьХранимыеНастройкиПрокси() Экспорт
	...
	Для Каждого ПользовательИБ Из МассивПользователейИБ Цикл
		...
		НастройкаПроксиСервера = ОбщегоНазначенияКлиентСерверДополнительно.ХранилищеОбщихНастроекЗагрузить(
		//
		...
		//Санлайн
				...
				ОбщегоНазначенияКлиентСерверДополнительно.ХранилищеОбщихНастроекСохранить(
				//
